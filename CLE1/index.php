    ...
    <body background="images/last4.jpg">
        <div id="wrapper">
            <div id="logo-menu">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <li><a href="LT2/Index.html">LT2</a></li>
                        <li><a href="LT3/index.html">LT3</a></li>
            ...
            <div id="contents">
                ...
                switch($show){
                    case 'CLE1MT':
                    require_once 'CLE1MT/index.html';
                        break;
                    case 'LT2':        
                    require_once 'LT2/Index.html';
                        break;
                    case 'LT3':
                    require_once 'LT3/index.html';
                        break;
                    case 'LT4':
                    require_once 'LT4/index.html';
                        break;
                    case 'LT5':
                    require_once 'LT5/index.html';
                        break;
                    default:
                }
                ?>
        ...
        <div id="block">
            ...
            <div id="man-text" >
                ...
                WELCOME ON BOARD<br/>
                    Please click on the images or menu.
                    <br/>
